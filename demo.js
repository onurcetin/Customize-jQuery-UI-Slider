...
function startRangeSlider() {
    ...
    $("#slider-range").dragslider({
        ...
        slide: function(event, ui) {
            ...
            if (ui.values[1] - ui.values[0] < 5 || ui.values[1] - ui.values[0] > 60) {
                ...
                //allow change
                $("#rangeBarPosition").val(ui.values[0] + " - " + ui.values[1]);
                $(".rangeBarBg.left").css("width", "calc(" + ui.values[0]  + "% - 5px)");

                rightDarkBgWidth = 100 - ui.values[1];
                $(".rangeBarBg.right").css("width", "calc(" + rightDarkBgWidth  + "% - 13px)");
            }
        }
    });
}